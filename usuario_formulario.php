			...
			<div style="padding-top: 30px;">
				...
				<form method="post" action="core/usuario_repositorio.php">
					...
					<div class="form-group">
						...
						<input onkeypress="mask(this, mphone);" class="form-control" type="text" require="required" id="telefone" name="usuario_telefone" value="<?php echo $entidade['usuario_telefone'] ?? '' ?>">
					</div>
					<div class="form-group">
